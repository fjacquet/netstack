...
- [ ] **Phase 25: Schema, Geometry Inputs & Advisory Foundation** — New advisories[] output type, store migration, geometry input fields (rack pitch, adjacency), DAC catalog fix
