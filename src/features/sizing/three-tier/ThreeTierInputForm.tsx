...
import { useThreeTierInputStore } from '@/store/threeTierInputStore'
import {
  Form,
  FormField,
  FormItem,
...
export function ThreeTierInputForm() {
  const { t } = useTranslation()
  const { input, setInput, resetInput } = useThreeTierInputStore(
  ...
  useEffect(() => {
    const subscription = form.watch((values, { name }) => {
      ...
      const {
        ...
        activeUplinksPerAccess: _ua, activeUplinksPerAggregation: _uag,
        ...rest
      } = v as FormValues
